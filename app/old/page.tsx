      ...
      <div className="mx-auto max-w-8xl px-4 sm:px-6 h-14 grid grid-cols-[1fr_auto_auto] gap-3 items-center">
        <div className="flex items-center gap-2 text-neutral-700 dark:text-neutral-300">
          ...
          <p className="font-medium">
            https://nicolasdestrac.com/oldsite/
          </p>
        </div>

        <div className="hidden md:flex items-center">
          <p className="text-1xl font-semibold">Ancien site pour mon activité d'accessoiriste de décor dans le cinéma codé sur bloc-note en 2013 (HTML/CSS).</p>
        </div>
