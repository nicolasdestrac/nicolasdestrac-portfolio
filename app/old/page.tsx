    ...
    <div className="w-full text-center">
      <div className="mx-auto max-w-6xl px-6 py-6">
        ...
        <h2 className="text-2xl text-neutral-600 dark:text-neutral-400">
          Première version de mon site internet pour mon activité d'accessoiriste de décor dans le cinéma. Le site avait était codé sur bloc-note en 2013 (HTML/CSS).
        </h2>
