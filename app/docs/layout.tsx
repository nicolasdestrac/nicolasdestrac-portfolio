  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 grid grid-cols-12 gap-8">
              ...
              <ul className="space-y-1">
                {section.items.map((it) => (
                  <li key={it.href}>
                    <Link
                      href={it.href}
                      className="block rounded px-2 py-1.5 text-sm text-neutral-300 hover:bg-neutral-900"
                    >
                      {it.label}
                    </Link>
                  </li>
        ...
        {/* Content */}
        <main className="col-span-12 md:col-span-9 lg:col-span-7 prose prose-invert prose-neutral max-w-none">
          {children}
        </main>
